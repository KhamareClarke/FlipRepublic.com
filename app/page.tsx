...
export default function HomePage() {
  ...
  return (
    <div className="bg-black">
      <section className="relative h-screen flex items-start sm:items-center justify-center overflow-hidden diagonal-lines pt-16 sm:pt-0">
        ...
        <Image
          ...
          priority
        />
        <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 text-center mt-2 sm:mt-0">
          <motion.div
          ...
          >
            <div className="mb-2 sm:mb-6 md:mb-8">
              <div className="inline-block px-4 sm:px-6 py-1.5 sm:py-2 luxury-border rounded-full mb-2 sm:mb-4 md:mb-6">
            ...
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl mb-2 sm:mb-6 md:mb-8 leading-[0.95] font-black tracking-tight">
              ...
              <span className="text-gradient-luxury text-luxury-shadow block mt-1 sm:mt-3">FOR ELITE RESALE</span>
            </h1>
            <div className="max-w-3xl mx-auto mb-4 sm:mb-8 md:mb-12">
              <p className="text-white/90 text-base sm:text-lg md:text-xl lg:text-2xl mb-3 sm:mb-6 leading-relaxed font-light tracking-wide px-2">
