      ...
      <section className="relative h-screen flex items-start sm:items-center justify-center overflow-hidden diagonal-lines">
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 text-center pt-[64px] sm:pt-0">
          ...
          >
            ...
            >
              <div className="inline-block px-5 sm:px-6 py-2 sm:py-2.5 luxury-border rounded-full">
                <span className="text-gold text-xs sm:text-sm uppercase tracking-wider-luxury font-semibold">Est. 2024 • Invitation Only</span>
              </div>
            </motion.div>
            
            {/* Main Title - Spacious and bold */}
            <motion.h1
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.7, delay: 0.2 }}
              className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[0.9] sm:leading-[0.95] font-black tracking-tight space-y-1 sm:space-y-2"
            >
            ...
            >
              <p className="text-white/90 text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed font-light tracking-wide px-2">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 md:gap-12 text-xs sm:text-sm text-white/50 mt-6 sm:mt-8">
