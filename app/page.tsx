...
export default function HomePage() {
  ...
  return (
    <div className="bg-black">
      <section className="relative h-screen flex items-start sm:items-center justify-center overflow-hidden diagonal-lines pt-20 sm:pt-0">
        ...
        <Image
          ...
          priority
        />
        <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 text-center mt-8 sm:mt-0">
          <motion.div
          ...
          >
            <div className="mb-4 sm:mb-6 md:mb-8">
              <div className="inline-block px-4 sm:px-6 py-1.5 sm:py-2 luxury-border rounded-full mb-3 sm:mb-4 md:mb-6">
            ...
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl mb-4 sm:mb-6 md:mb-8 leading-[0.95] font-black tracking-tight">
